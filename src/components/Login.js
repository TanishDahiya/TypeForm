...
import { signinApi } from "../utils/api-calling.js";
import { doLogin } from "../auth/authenticateconfig";
...
function Login() {
  ...
  const handleSubmit=(event)=>{
    ...
    //SUBMIT THE DATA TO THE BACK END AND GENERATE JWT TOKEN
    signinApi(loginData).then((jwtToken)=>{
      console.log(jwtToken)
      //SAVE THE DATA OR JWT TOKEN TO LOCAL STORAGE
      doLogin(jwtToken,()=>{
